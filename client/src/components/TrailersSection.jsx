  ...
  return (
    ...
    <div className='group grid grid-cols-4 gap-4 md:gap-8 mt-8 max-w-3xl mx-auto'>
      {dummyTrailers.map((trailer) => (
        <div key={trailer.image} className='relative transition duration-300 transform hover:-translate-y-1 cursor-pointer max-md:h-60 md:max-h-60' onClick={() => setCurrentTrailer(trailer)}>
          <img
            src={trailer.image}
            alt="trailer"
